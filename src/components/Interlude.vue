<template>
  <div class="tw-w-screen tw-h-screen tw-overflow-hidden tw-fixed tw-bg-blue-400 tw-top-0 tw-left-0 tw-flex tw-justify-center tw-items-center animate__animated animate__faster" :class="{'animate__fadeOut':!show_loading_page}" :style="{'z-index':zindex}" style="pointer-events:auto" @contextmenu.prevent="{}">
